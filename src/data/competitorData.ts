...
const SHARED_THEMES = (youBase: number, compBase: number): CompetitorThemeRow[] => [
  { theme: 'Wisdom teeth removal',  youVisibility: youBase,        youDelta: 3.2,  competitorVisibility: compBase,        competitorDelta: 1.1, gap: youBase - compBase },
  ...
  { theme: 'Tooth extraction',      youVisibility: youBase - 8.4,  youDelta: -1.3, competitorVisibility: compBase + 2.1,  competitorDelta: 2.4, gap: (youBase - 8.4) - (compBase + 2.1) },
...
export const THEME_VISIBILITY_DATA: ThemeVisibilityThemeRow[] = [
  {
    ...
    prompts: makePrompts('theme-1', [
      ...
      'Best clinics for wisdom teeth removal in my area',
      'Top rated oral surgeons for wisdom teeth extraction nearby',
    ], 51.3, 25.4),
  },
  {
    _id: 'theme-2',
  ...
  },
  {
    ...
    prompts: makePrompts('theme-3', [
      'Find dental implant specialists near me',
      'Best clinics for all on 4 dental implants in my area',
      'Locate affordable dental implant services nearby',
    ], 38.9, 14.6),
  },
  {
    _id: 'theme-4',
    theme: 'Tooth extraction',
    ...
    prompts: makePrompts('theme-4', [
      'Find affordable wisdom tooth extraction specialists near me',
      'Top rated tooth extraction clinics in my area',
      'Search for local dental offices offering tooth extraction services',
    ], 33.2, 11.8),
  },
  {
    _id: 'theme-5',
    theme: 'Teeth cleaning',
    ...
    prompts: makePrompts('theme-5', [
      'Find teeth cleaning services near me',
      'Best dental clinics for ultrasound teeth cleaning in my area',
      'Top rated dentists for plaque removal and teeth cleaning nearby',
    ], 29.8, 9.4),
  },
]
